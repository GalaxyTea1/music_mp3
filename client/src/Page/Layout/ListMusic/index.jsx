        ...
        <div className='listMusic'>
            <div className='py-4'>
                <div className='px-2 flex  items-center'>
                    ...
                    <button className='rounded-full w-8 h-8 flex justify-center items-center bg-pink-500 text-white mr-2'><i className="fa fa-clock"></i></button>
                    <button className='button__vip rounded-full w-8 h-8 flex justify-center items-center  text-white'><i className="fa fa-align-justify"></i></button>
                </div>
            </div>
