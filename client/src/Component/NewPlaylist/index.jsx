...
export default function NewPlaylist() {
    ...
    return (
        <div ref={playlistRef} className='createPlaylist'>
            ...
            <div>
                <form ref={myFormRef}>
                    <input name='playlistName' placeholder='Nhập tên playlist' onChange={handleChange}></input>
                </form>
            </div>
            <div>
                {valueInput.playlistName === '' || valueInput.playlistName.trim() === '' ? <button disabled style={{ opacity: "0.6", cursor: 'not-allowed' }}>
                    Tạo mới
